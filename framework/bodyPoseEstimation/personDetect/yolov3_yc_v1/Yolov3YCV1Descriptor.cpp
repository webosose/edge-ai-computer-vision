...
Yolov3YCV1Descriptor::Yolov3YCV1Descriptor()
...
void Yolov3YCV1Descriptor::addPerson(float score, const BBox &bbox)
{
...
void Yolov3YCV1Descriptor::drawBbox(std::string imgPath)
{
...
void Yolov3YCV1Descriptor::clear()
{
