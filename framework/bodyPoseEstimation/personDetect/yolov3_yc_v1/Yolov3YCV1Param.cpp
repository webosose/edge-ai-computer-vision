...
Yolov3YCV1Param::Yolov3YCV1Param()
    : detectObject("body")
    , gt_bboxes()
    , origImgRoiX(0)
    , origImgRoiY(0)
...
Yolov3YCV1Param::Yolov3YCV1Param(const Yolov3YCV1Param& other)
...
Yolov3YCV1Param::Yolov3YCV1Param(Yolov3YCV1Param&& other) noexcept
...
Yolov3YCV1Param& Yolov3YCV1Param::operator=(const Yolov3YCV1Param& other)
{
...
Yolov3YCV1Param& Yolov3YCV1Param::operator=(Yolov3YCV1Param&& other) noexcept
{
...
bool Yolov3YCV1Param::operator==(const Yolov3YCV1Param& other) const
{
    return (
        (detectObject == other.detectObject) &&
        (gt_bboxes == other.gt_bboxes) &&
...
// debug
std::ostream& operator<<(std::ostream& os, const Yolov3YCV1Param& fp)
{
    os << "\n{\n";
...
t_aif_status Yolov3YCV1Param::fromJson(const std::string& param)
{
