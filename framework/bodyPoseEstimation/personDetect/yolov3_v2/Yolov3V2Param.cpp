...
Yolov3V2Param::Yolov3V2Param(const Yolov3V2Param& other)
...
Yolov3V2Param::Yolov3V2Param(Yolov3V2Param&& other) noexcept
...
Yolov3V2Param& Yolov3V2Param::operator=(const Yolov3V2Param& other)
{
...
Yolov3V2Param& Yolov3V2Param::operator=(Yolov3V2Param&& other) noexcept
{
...
bool Yolov3V2Param::operator==(const Yolov3V2Param& other) const
{
    return (
        (detectObject == other.detectObject) &&
        (gt_bboxes == other.gt_bboxes) &&
...
// debug
std::ostream& operator<<(std::ostream& os, const Yolov3V2Param& fp)
{
    os << "\n{\n";
...
t_aif_status Yolov3V2Param::fromJson(const std::string& param)
{
