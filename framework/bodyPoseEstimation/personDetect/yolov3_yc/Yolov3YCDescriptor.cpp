...
Yolov3YCDescriptor::Yolov3YCDescriptor()
...
void Yolov3YCDescriptor::addPerson(float score, const BBox &bbox)
{
...
void Yolov3YCDescriptor::drawBbox(std::string imgPath)
{
