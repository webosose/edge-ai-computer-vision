...
class Yolov4DescriptorTest : public ::testing::Test
{
protected:
    Yolov4DescriptorTest() = default;
    ~Yolov4DescriptorTest() = default;
...
TEST_F(Yolov4DescriptorTest, 01_constructor)
{
    Yolov4Descriptor jfd;
    auto json = jfd.toStr();
    Logd(json);
...
TEST_F(Yolov4DescriptorTest, 02_addperson_one)
{
    Yolov4Descriptor jfd;
...
TEST_F(Yolov4DescriptorTest, 03_addperson_two)
{
    Yolov4Descriptor jfd;
...
TEST_F(Yolov4DescriptorTest, 04_add_response_and_returncode)
{
    Yolov4Descriptor jfd;
