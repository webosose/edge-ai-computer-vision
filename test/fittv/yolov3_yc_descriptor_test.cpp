...
class Yolov3YCDescriptorTest : public ::testing::Test
{
protected:
    Yolov3YCDescriptorTest() = default;
    ~Yolov3YCDescriptorTest() = default;
...
TEST_F(Yolov3YCDescriptorTest, 01_constructor)
{
    Yolov3YCDescriptor jfd;
    auto json = jfd.toStr();
    Logd(json);
...
TEST_F(Yolov3YCDescriptorTest, 02_addperson_one)
{
    Yolov3YCDescriptor jfd;
...
TEST_F(Yolov3YCDescriptorTest, 03_addperson_two)
{
    Yolov3YCDescriptor jfd;
...
TEST_F(Yolov3YCDescriptorTest, 04_add_response_and_returncode)
{
    Yolov3YCDescriptor jfd;
...
TEST_F(Yolov3YCDescriptorTest, 05_add_face)
{
    Yolov3YCDescriptor jfd;
