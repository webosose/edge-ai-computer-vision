...
class Yolov3V2DescriptorTest : public ::testing::Test
{
protected:
    Yolov3V2DescriptorTest() = default;
    ~Yolov3V2DescriptorTest() = default;
...
TEST_F(Yolov3V2DescriptorTest, 01_constructor)
{
    Yolov3V2Descriptor jfd;
    auto json = jfd.toStr();
    Logd(json);
...
TEST_F(Yolov3V2DescriptorTest, 02_addperson_one)
{
    Yolov3V2Descriptor jfd;
...
TEST_F(Yolov3V2DescriptorTest, 03_addperson_two)
{
    Yolov3V2Descriptor jfd;
...
TEST_F(Yolov3V2DescriptorTest, 04_add_response_and_returncode)
{
    Yolov3V2Descriptor jfd;
...
TEST_F(Yolov3V2DescriptorTest, 05_add_face)
{
    Yolov3V2Descriptor jfd;
