...
class Yolov3V1DetectorTest : public ::testing::Test
{
protected:
    Yolov3V1DetectorTest() = default;
    ~Yolov3V1DetectorTest() = default;
...
TEST_F(Yolov3V1DetectorTest, 01_yolov3_detect_person)
{
    auto fd = std::dynamic_pointer_cast<Yolov3V1Detector>(DetectorFactory::get().getDetector("person_yolov3_v1_npu", use_npu_delegate));
...
TEST_F(Yolov3V1DetectorTest, 02_yolov3_detect_face)
{
...
TEST_F(Yolov3V1DetectorTest, 03_yolov3_detect_90_pose_person)
{
...
TEST_F(Yolov3V1DetectorTest, 04_yolov3_detect_people)
{
...
TEST_F(Yolov3V1DetectorTest, 05_yolov3_detect_not_people_default)
{
...
TEST_F(Yolov3V1DetectorTest, 06_yolov3_detect_not_people)
{
...
TEST_F(Yolov3V1DetectorTest, 07_yolov3_detect_person_in_people)
{
...
TEST_F(Yolov3V1DetectorTest, 08_yolov3_detect_person2_in_people)
{
...
TEST_F(Yolov3V1DetectorTest, 09_yolov3_detect_person_iou_update)
{
    /* 0.7 */
    auto fd = DetectorFactory::get().getDetector("person_yolov3_v1_npu", use_npu_delegate);
    EXPECT_TRUE(fd.get() != nullptr);
...
TEST_F(Yolov3V1DetectorTest, 10_yolov3_detect_person_iou_update1)
{
    /* 0.9 */
...
TEST_F(Yolov3V1DetectorTest, 11_yolov3_detect_person_iou_update2)
{
    /* 1.0 */
...
TEST_F(Yolov3V1DetectorTest, 12_yolov3_detect_person_iou_update3)
{
    /* 0.5 */
