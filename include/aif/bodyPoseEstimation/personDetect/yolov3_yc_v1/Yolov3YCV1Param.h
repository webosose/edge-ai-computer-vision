...
#ifndef AIF_YOLOV3_YC_V1_PARAM_H
#define AIF_YOLOV3_YC_V1_PARAM_H
...
class Yolov3YCV1Param : public BodyPoseEstimationParam
{
public:
    Yolov3YCV1Param();
    virtual ~Yolov3YCV1Param();
    Yolov3YCV1Param(const Yolov3YCV1Param& other);
    Yolov3YCV1Param(Yolov3YCV1Param&& other) noexcept;

    Yolov3YCV1Param& operator=(const Yolov3YCV1Param& other);
    Yolov3YCV1Param& operator=(Yolov3YCV1Param&& other) noexcept;

    bool operator==(const Yolov3YCV1Param& other) const;
    bool operator!=(const Yolov3YCV1Param& other) const;

    // debug
    friend std::ostream& operator<<(std::ostream& os, const Yolov3YCV1Param& fp);
    void trace();
...
#endif // AIF_YOLOV3_YC_V1_PARAM_H
