...
#ifndef AIF_YOLOV3_V1_DESCRIPTOR_H
#define AIF_YOLOV3_V1_DESCRIPTOR_H
...
class Yolov3V1Descriptor: public PersonDetectDescriptor, public FaceDescriptor
{
public:
    Yolov3V1Descriptor();
    virtual ~Yolov3V1Descriptor();
...
#endif // AIF_YOLOV3_V1_DESCRIPTOR_H
